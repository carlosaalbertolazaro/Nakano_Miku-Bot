...
const defaults = {
  ...
  // .iamodo — 'normal': participa de vez en cuando (default). 'constante':
  // responde casi todo. 'silencio': solo si le hablan directo (mención,
  // reply, comando o DM), nunca por su cuenta.
  aiMode: 'normal',

...
// preservando el canal alfa, dando el efecto "¿Quién es este Pokémon?". Se
// aplica un blur leve después para suavizar bordes filosos/dentados que
// quedan raros en algunos Pokémon con detalles finos (llamas, efectos, etc.)
// al ennegrecerlos de forma uniforme.
export async function generateSilhouette(imageUrl) {
  const res = await fetch(imageUrl, { headers: { 'User-Agent': 'NakanoMikuBot (https://github.com/carlosaalbertolazaro/Nakano_Miku-Bot)' } })
